...
var okcoinHost = "https://www.okcoin.cn/api/v1/"
var okcoinStockType = map[string]string{"BTC": "btc_cny", "LTC": "ltc_cny"}
var okcoinWithFee = map[string]string{"BTC": "0.0001", "LTC": "0.001"}
var okcoinOrderType = map[string]int{"buy": 1, "sell": -1, "buy_market": 2, "sell_market": -2}
var okcoinPeriod = map[string]string{"1m": "1min", "5m": "5min", "15m": "15min", "30m": "30min", "1h": "1hour", "1d": "1day", "1w": "1week"}

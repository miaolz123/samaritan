...
var document=global.document;var scripts=document.getElementsByTagName('script');var flashpath=((scripts.length>0)&&scripts[scripts.length-1].getAttribute('flashpath'))||global.hproseFlashPath||'';scripts=null;var localfile=(global.location!==undefined&&global.location.protocol==='file:');var XMLHttpRequest=global.XMLHttpRequest;var nativeXHR=(typeof(XMLHttpRequest)!=='undefined');var corsSupport=(!localfile&&nativeXHR&&'withCredentials'in new XMLHttpRequest());var flashID='flashhttprequest_as3';var flashSupport=false;var request=null;var callbackList=[];var jsTaskQueue=[];var swfTaskQueue=[];var jsReady=false;var swfReady=false;function checkFlash(){if(!navigator){return 0;}
